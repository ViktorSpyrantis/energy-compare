...
const rawPrograms: ProgramData[] = [
  ...
  },
  {
    ...
    cons: ["24μηνη συμβατική δέσμευση", "Ρήτρα αποχώρησης"],
  ...
  },
  {
    ...
    isProgram: true,
    features: [
      "Σταθερή τιμή 0.095€/kWh για τα πρώτα 150 kWh/μήνα",
      "Χωρίς δέσμευση ή ρήτρα αποχώρησης",
      "Ιδανικό για μικρά σπίτια & φοιτητές",
      "Mobile app NRG για παρακολούθηση",
    ],
    pros: [
      "Πολύ χαμηλή τιμή kWh (0.095€) για την πρώτη κατανάλωση",
      "Χωρίς συμβατική δέσμευση",
  ...
  },
  {
    ...
    signupUrl:
      "https://www.protergia.gr/spiti/oikiako-reuma-proionta/protergia-picasso-student/",
    lastUpdated: "2026-03",
  },
  {
  ...
  },
  {
    ...
    programEligibility: "Απαιτείται φοιτητική ταυτότητα ή πάσο",
    features: [
      "Αποτελεσματική τιμή ~0.095€/kWh μετά από έκπτωση 20% συνέπειας",
      "Χωρίς συμβατική δέσμευση",
      "Δωρεάν πάγιο καλοκαίρι (Ιούν–Αύγ)",
  ...
  },
  {
    ...
    newCustomerOffer: "Χωρίς ρήτρα αποχώρησης",
    signupUrl:
      "https://www.watt-volt.gr/ilektriko-revma/gia-to-spiti/value-student/",
    lastUpdated: "2026-03",
  },
  ...
  // supplyRate = σταθμισμένος μ.ο. με DEFAULT_COLOR_DISTRIBUTION (35/25/20/20)
  {
    ...
    pros: [
      "Πολύ φθηνό ρεύμα Μπλε ζώνης (0.078€)",
      "Μεγάλη εξοικονόμηση για νυχτερινούς χρήστες",
      "Αξιόπιστος πάροχος",
    ],
    cons: [
      "Ακριβό ρεύμα Κόκκινης ζώνης (0.185€)",
