...
export const providers: Provider[] = [
  ...
  },
  {
    id: "fysiko-aerio",
    name: "Φυσικό Αέριο",
    fullName: "Φυσικό Αέριο Ελληνική Εταιρεία Ενέργειας",
    logoText: "ΦΑ",
    primaryColor: "#d97706",
    bgColor: "#fffbeb",
    textColor: "#d97706",
    ...
    supplyRate: 0.133,
    greenEnergy: true,
    greenEnergyPercent: 35,
    features: [
      "Προμήθεια ρεύματος & φυσικού αερίου",
      "Έκπτωση dual energy (ρεύμα + αέριο)",
      "Online διαχείριση λογαριασμού",
      "Έκπτωση e-bill & direct debit",
    ],
    pros: [
      "Ενιαίος λογαριασμός ρεύματος & αερίου",
      "Ανταγωνιστική τιμή kWh",
      "Έκπτωση 10% dual energy",
    ],
    cons: [
      "Περιορισμένα φυσικά καταστήματα",
      "Καλύτερη τιμή μόνο με dual energy",
    ],
    phone: "210 7770777",
    tags: ["Σταθερή τιμή", "Dual Energy", "Ετήσιο συμβόλαιο"],
    popular: false,
    newCustomerOffer: "Έκπτωση 10% σε dual energy (ρεύμα + αέριο)",
