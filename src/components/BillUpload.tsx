        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-2xl shadow-xl max-w-md mx-4 p-6 text-center">
            ...
            <p className="text-gray-600 mb-6">
              {rejectionPopup === "gas" ? (
                <>
                  Ο λογαριασμός που ανέβασες αφορά <strong>φυσικό αέριο</strong>
                  , όχι ηλεκτρικό ρεύμα. Παρακαλώ ανέβασε έναν λογαριασμό{" "}
                  <strong>ηλεκτρικής ενέργειας</strong> για να συνεχίσεις τη
                  σύγκριση.
                </>
              ) : (
                <>
                  Το αρχείο που ανέβασες{" "}
                  <strong>δεν είναι λογαριασμός ρεύματος</strong>. Παρακαλώ
                  ανέβασε έναν λογαριασμό <strong>ηλεκτρικής ενέργειας</strong>{" "}
                  για να συνεχίσεις τη σύγκριση.
                </>
              )}
            </p>
            <button
              onClick={dismissRejectionPopup}
              className="w-full px-5 py-2.5 bg-teal-600 hover:bg-teal-700 text-white font-semibold rounded-xl transition-colors cursor-pointer"
            >
              Κατάλαβα
            </button>
          </div>
